...
sample.metadata <- readxl::read_excel("data/2025-02-19_mfd_db.xlsx") %>%
...
df <- data.table::fread("data/2024-03-07_MFD_arcbac_shallow_release.csv")
...
data.table::fwrite(df.sub.phylum, sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE,
                   paste0("output/", format(Sys.time(), "%Y-%m-%d"), "_MFD_arcbac_aggregated_phylum.csv"))
...
data.table::fwrite(df.sub.class, sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE,
                   paste0("output/", format(Sys.time(), "%Y-%m-%d"), "_MFD_arcbac_aggregated_class.csv"))
...
data.table::fwrite(df.sub.order, sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE,
                   paste0("output/", format(Sys.time(), "%Y-%m-%d"), "_MFD_arcbac_aggregated_order.csv"))
...
data.table::fwrite(df.sub.family, sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE,
                   paste0("output/", format(Sys.time(), "%Y-%m-%d"), "_MFD_arcbac_aggregated_family.csv"))
...
data.table::fwrite(df.sub.genus, sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE,
                   paste0("output/", format(Sys.time(), "%Y-%m-%d"), "_MFD_arcbac_aggregated_genus.csv"))
...
data.table::fwrite(df.sub.species, sep = ",", row.names = FALSE, col.names = TRUE, quote = FALSE,
                   paste0("output/", format(Sys.time(), "%Y-%m-%d"), "_MFD_arcbac_aggregated_species.csv"))
