...
genus.table.euk <- data.table::fread('output/2025-02-13_MFD_euk_aggregated_genus.csv', 
                                        sep = ",", header = TRUE)
...
save.image(paste0('release/', format(Sys.time(), "%Y-%m-%d"), "_MFD_ampvis_euk_data.RData"))
